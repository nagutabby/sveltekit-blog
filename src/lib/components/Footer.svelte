<footer class="footer bg-base-100">
  <div
    class="container sm:px-5 lg:px-15 py-5 flex justify-center items-center gap-x-8 mx-auto flex-wrap sm:flex-nowrap"
  >
    <nav class="flex flex-col gap-y-1 w-[30%] sm:w-[15%] md:w-[10%]">
      <p class="footer-title mx-auto">Contact</p>
    ...
    <nav class="flex flex-col gap-y-1 w-[30%] sm:w-[15%] md:w-[10%]">
      <p class="footer-title mx-auto">Mastodon</p>
      <a
        rel="me"
    ...
    <nav class="flex flex-col gap-y-1 w-[30%] sm:w-[15%] md:w-[10%]">
      <p class="footer-title mx-auto">GitHub</p>
      <a
    ...
    <nav class="flex flex-col gap-y-1 w-[30%] sm:w-[15%] md:w-[10%]">
      <p class="footer-title mx-auto">RSS</p>
      <a
        href="/atom.xml"
        target="_blank"
        aria-label="RSS"
